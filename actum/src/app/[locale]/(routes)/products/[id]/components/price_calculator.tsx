      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-8">
        <div className="flex flex-col gap-4">
          ...
          {categoryKeys.map((categoryKey) => {
            ...
            // Vi genererer et unikt id til hvert select-element baseret på kategorinavnet.
            // Det bruges til at koble label og select sammen via htmlFor og id –
            // et krav for tilgængelighed, så skærmlæsere kan fortælle brugeren hvad der skal vælges.
            const selectId = `select-${categoryKey}`;

            return (
              <div key={categoryKey} className="relative min-w-64">
                {/* label er visuelt skjult med sr-only, men læses af skærmlæsere.
                htmlFor matcher selectId nedenfor og kobler label og select sammen. */}
